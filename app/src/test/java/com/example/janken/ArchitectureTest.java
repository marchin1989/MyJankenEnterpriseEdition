...
public class ArchitectureTest {
    ...
    @ArchTest
    public static final ArchRule レイヤーの依存向きが設計通り = Architectures
            .layeredArchitecture()
            ...
            .whereLayer(APPLICATION_LAYER).mayOnlyBeAccessedByLayers(ROOT_PACKAGE, PRESENTATION_LAYER)
            // HealthAPIControllerがinfrastructureにアクセスするため、PRESENTATION_LAYERも許可
